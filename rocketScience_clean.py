"""rocketScience_clean.py

Clean, documented implementation of the rocket fin stability helper functions
and a simple CLI. This is intended as a drop-in improved version of
`rocketScience.py` for testing and review; you can replace the original file
when ready.
"""
